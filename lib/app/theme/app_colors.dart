...
class AppColors {
  ...
  // Primary Colors - Nivaas Orange/Warm
  static const Color primary = Color(0xFFFF6518);
  ...
  // Login/Auth Colors (Orange theme)
  static const Color authPrimary = Color(0xFFFF6518);
